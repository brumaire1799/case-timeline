...
2. **默认配色**：自动分配默认颜色（上方暖色系，下方冷色/暗色系）和默认位置，以表格展示
3. **自定义配色**：逐方询问用户是否调整——不满意可指定色值、从调色板选择、或描述期望颜色；位置（上/下）也可逐方调整
4. **两方场景简化**：如只有两方，按"原告 vs 被告 / 上诉人 vs 被上诉人 / 申请人 vs 被申请人"三选一快速确认，同样支持逐方自定义
